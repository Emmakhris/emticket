"""
Django settings for emticket project.
...
#SECRET_KEY = 'django-insecure-9^)cm$2iq3+p(oxqc7v8w*wwqn2t-6xmp$-_gli+895q$ubeya' --comented by em
...
# How often to scan for SLA breaches (seconds)
SLA_SCAN_INTERVAL_SECONDS = 60

# Escalation checkpoints (fractions of total allowed time)
# Example: 0.7 means "70% of time elapsed"
SLA_ESCALATION_THRESHOLDS = [0.7, 0.9, 1.0]

# Which statuses pause SLA
